  ...
  private get queryBuilder() {
    if (!this._queryBuilder) {
      throw new InternalServerException(
        `Query builder does not exist in ${SqliteDriver.name}, this usually happens when you don't have called connect method to create the connection with database`,
      )
    }
